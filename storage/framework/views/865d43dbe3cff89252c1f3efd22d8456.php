                    ...
                    <thead>
                      ...
                      <tbody>
                        <?php if(count($data)>0): ?>
                          ...
                          <td>
                          <a href="/editData/<?php echo e($value->id); ?>" style="color:white;text-decoration:none;">><button class="btn btn-info">Edit</buttom></a>
                          <a href="/delete/<?php echo e($value->id); ?>" style="color:white;text-decoration:none;"><button class="btn btn-danger">Delete</a>
                          </td>
                        </tr>
...
</html><?php /**PATH /home/noufal/projects/laravel-vue/laravel-vue/resources/views/hello.blade.php ENDPATH**/ ?>